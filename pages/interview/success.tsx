...
export default function Success() {
    ...
    return <main className="landing">
        ...
        {user_data.admin && <>
            <a className='landing-link'><Link href={`/gift_card/${gift_card_id}/disperse`}>Disperse Gift Card</Link></a>
            ...
            <a className='landing-link'><Link href={`/interview_detail/${interview_data.id}`}><>Review Client {interview_data.PID} {titleCase(interview_data.type.split("_").join(" "))} Interview</></Link></a>
