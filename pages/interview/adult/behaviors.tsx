...
import drugBehaviorQs from "../../../question_data/adult/drug-behavior.json";
import sexualBehaviorQs from "../../../question_data/adult/sexual-behavior.json"
...
export default function Behavior() {
    const [drug, setDrugBehaviors] = useState({
        smoke_cigarettes: 0,
        tobacco_products: 0,
        electronic_vapor: 0,
        alcohol: 0,
    ...
    const [sexual, setSexualBehavior] = useState({
        sexual_partners: '',
    ...
    const behavior_info = { drug, sexual }
